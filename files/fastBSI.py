...
if __name__ == '__main__':
    ...
    parser.add_argument('--instant', default=False, help='if the full increase should be done in the 6th epoch')
    parser.add_argument('--max', default=128, type=int, help='the maximal batch size to be reached')
   ...
   # Data loading code
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        if epoch > 5 and batch_size < args.max:
            if args.instant:
                batch_size = 8192
